...
namespace Server
{
    ...
    public partial class ServerForm : Form
    {
        ...
        /// <summary>
        /// ServerForm's constructor, initialize graphical components and create two threads that 
        /// manage video recording and upload of images from the client.
        /// </summary>
        public ServerForm()
        {
            InitializeComponent();
        ...
        /// <summary>
        /// Initialize TCP socket that listens for data exchange with the client. With support of a TCPListener and a TCPClient objects 
        /// preparing the upload of the images from the client's SD card to the server's database. 
        /// </summary>
        ...
        /// <summary>
        /// Initialize TCP socket that listens for video streaming from the client. With support of a TCPListener and a TCPClient objects 
        /// preparing the upload of the video streaming from the client's camera to the server's database.
        /// </summary>
        ...
        /// </summary>
        /// <param name="obj">TCPClient object that identifies the client connected.</param>
        /// <param name="streaming">(bool) if true the established connection is dedicated to video streaming, else to photo uploading.</param>
        public void ClientConnection(object obj, bool streaming)
        {
        ...
        /// </summary>
        /// <param name="obj">NetworkStream that identifies the source of the data flow. </param>
        ...
        /// </summary>
        /// <param name="obj">NetworkStream that identifies the source of the data flow. </param>
        public void StreamingVideo(object obj)
        {
            images = new List<Image>();
            // Buffer for reading data
            byte[] bytes = new byte[230454];
        ...
        /// </summary>
        /// <returns>The name of the zipped folder's path as a string.</returns>
        ...
        /// </summary>
        /// <param name="sender">Button "Send" that the user pressed.</param>
        /// <param name="e">List of any event data.</param>
        ...
        /// <summary>
        /// Event on the check box. It start when the user checks or unchecks one image or one video in the check box. In the first case, the method inserts its
        /// path in the global array "attachment" to include it in the zipped folder that the user would like to send via email, otherwise it provides to remove
        /// the same path from the array. 
        /// </summary>
        /// <param name="sender">Check box in which the selection was made.</param>
        /// <param name="e">List of any event data.</param>
